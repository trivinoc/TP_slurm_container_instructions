...
Le TP est hébergé sur une Machine Virtuelle (VM) chez le fournisseur OVH et est accessible par ssh avec le login <br>almalinux</br>. Le mot de passe vous sera communiqué en séance. Exemple de connexion : 
```
